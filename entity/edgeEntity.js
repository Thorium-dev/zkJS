...
var methods = {
        ...
        /**
         * Permet de tester si un élément possède un style.
         *
         * @method hasStyle
         ...
         * @since 1.0
         */
        "hasCss": function (property) {
            return this.getCss(property) ? true : false;
        },
        /**
         * Permet d'obtenir les styles calculés par les navigateurs.
         *
         * @method getCss
        ...
        "getCss": function (property) {
            ...
            if(node){
                ...
                // console.log(css.hasOwnProperty(property));
