...
zk().setContainer(arrayGetFirstPath + "other", function () {
    return []
});
...
zk().setContainer(arrayGetLastPath + "other", function () {
    return []
});
...
zk().setContainer(arrayRemoveAtPath + "number", function (el, indexes) {
...
zk().setContainer(arrayRemovePath + "number", function (el, value) {
